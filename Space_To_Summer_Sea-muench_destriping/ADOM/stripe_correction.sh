...
BASE_DIR="/Volumes/LaCie/test_images"
# BASE_DIR="/Volumes/LaCie/Processing/0910_MATLAB_TEST_BATCH"
MATLAB_GRAYSCALE_SCRIPT_PATH="/Users/alexfranks/Projects/SPACE_TO_SUMMER_SEA_UROP/IAP_2025/destriping/testing/ADOM/ADOM_processing_singleimage.m"
...
MATLAB_RGB_SCRIPT_PATH="/Users/alexfranks/Projects/SPACE_TO_SUMMER_SEA_UROP/IAP_2025/destriping/testing/ADOM/ADOM_processing_singleimage_auto.m"
...
for dir in $BASE_DIR/*; do
    if [ -d "$dir/seadas" ]; then
        ...
        sed -i "" "s|^savefolder = .*|savefolder = '$ADOM_DIR';|" "$MATLAB_GRAYSCALE_SCRIPT_PATH"
        ...
        sed -i "" "s|^savefolder = .*|savefolder = '$ADOM_DIR';|" "$MATLAB_RGB_SCRIPT_PATH"
